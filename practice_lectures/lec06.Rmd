...
For the purposes of the homework, you should use the method "BFGS". In real life, you have to play around and see what happens! No optimization method works well for all situtations. Read the documentation and read up on these methods on wikipedia.
