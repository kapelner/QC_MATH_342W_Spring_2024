...
\paragraph{Computer Software:} You need your own laptop and it is required to bring to class. We will be using \texttt{R}which is free, open source programming languages available for all operating systems. To download \texttt{R} go to \url{http://cran.mirrors.hoobly.com/}. I then recommend the IDE \texttt{RStudio} available for free at \url{https://www.rstudio.com/products/rstudio/download/} this way you can follow the demos in class.
